...
$query_pasien = "SELECT id, nama FROM unit_kerja";
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Tabel Pramedik</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Tabel Pramedik</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="paramedik/action_add.php" method="post">
                            <!-- Formulir untuk menambah data paramedik -->
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
        ...
        <table id="data_pasien" class="table table-bordered table-hover dataTable dtr-inline" aria-describedby="data_pasien_info">
            <thead>
                <tr>
                    ...
                    <th class="sorting" tabindex="0" aria-controls="data_pasien" rowspan="1" colspan="1">Kategori</th>
                    <th class="sorting" tabindex="0" aria-controls="data_pasien" rowspan="1" colspan="1">Telfon</th>
                    <th class="sorting" tabindex="0" aria-controls="data_pasien" rowspan="1" colspan="1">Alamat</th>
                    <th class="sorting" tabindex="0" aria-controls="data_pasien" rowspan="1" colspan="1">Unit Kerja Id</th>
                    <?php if ($role === 'admin') : ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if ($role === 'admin') : ?>
                                ...
                                <a type="button" class="btn btn-danger mb-2" href="paramedik/action_delete.php?id=<?= $row['id'] ?>&delete=delete">Delete</a>
                            <?php endif; ?>
                        </td>
                    </tr>
                    ...
                    <div class="modal fade" id="editModal<?= $row['id'] ?>" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="paramedik/action_edit.php" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="editGender" name="gender" value="<?= $row['gender'] ?>">
                                                </div>
                                                <div class="mb-3">
                                            ...
                                            <div class="col-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="editKategori" name="kategori" value="<?= $row['kategori'] ?>">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="editTelpon" class="form-label">Telpon</label>
                                                    <input type="text" class="form-control" id="editTelpon" name="telpon" value="<?= $row['telpon'] ?>">
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-control" id="unit_kerja_id" name="unit_kerja_id">
                                                        <?php foreach ($pasiens as $pasien) : ?>
                                                            <option value="<?php echo $pasien['id']; ?>" <?php echo ($row['unit_kerja_id'] == $pasien['id']) ? 'selected' : ''; ?>><?php echo $pasien['id']; ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                            </div>
