            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="unitkerja/action_add.php" method="post">
                    ...
                    <tr>
                        ...
                        <?php if ($role === 'admin') : ?>
                            <td>
                                ...
                                <a type="button" class="btn btn-danger mb-2" href="unitkerja/action_delete.php?id=<?= $row['id'] ?>&delete=delete">Delete</a>
                            </td>
                        <?php endif; ?>
                    </tr>
                    ...
                    <div class="modal fade" id="editModal<?= $row['id'] ?>" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="unitkerja/action_edit.php" method="post">
